...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "com.tyu.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "com.tyu.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "com.tyu.mail.routing.key";
}
